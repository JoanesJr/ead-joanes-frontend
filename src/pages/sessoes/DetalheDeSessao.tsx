      ...
      sectionService.getById(id).then((result) => {
        ...
        if (result instanceof Error) {
          ...
          if (result.file) {
            ...
            setImage(
              "https://images.tcdn.com.br/img/img_prod/852394/sessao_online_meu_primeiro_huawei_iniciacao_para_roteador_de_borda_huawei_297_1_8178f580feb2beae96a9365e3ab6ff85.png"
            );
          }
    ...
    <LayoutBaseDePagina
      ...
      barraDeFerramentas={
        <FerramentasDeDetalhe
          ...
          aoClicarEmVoltar={() => navigate("/sessaos")}
